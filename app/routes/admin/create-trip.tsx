import { ComboBoxComponent, setPlaceHolder } from "@syncfusion/ej2-react-dropdowns"
import { Header } from "components"
import type { Route } from "./+types/create-trip";
import { updateData } from "@syncfusion/ej2-react-grids";
import { comboBoxItems, selectItems } from "~/constants";
import { cn, formatKey } from "~/lib/util";
...
const CreateTrip = ({loaderData}:Route.ComponentProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if(
            ...
            setError('Please provide all values for all fields!');
            setLoading(false)
            return; 
        }
